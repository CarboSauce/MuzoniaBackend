...
//             else
//             {
//                 var jsonApplicationType =
//                     mvc.Value.FormatterMappings.GetMediaTypeMappingForFormat(
//                         "json"
//                     );
//                 if (jsonApplicationType != null)
//                     apiResponseTypes.Add(jsonApplicationType);
//                 var xmlApplicationType =
//                     mvc.Value.FormatterMappings.GetMediaTypeMappingForFormat(
//                         "xml"
//                     );
...
//
//         if (
//             typeof(IEndpointMetadataProvider).IsAssignableFrom(actionReturnType)
//         )
//         {
//             var populateMetadataMethod = actionReturnType.GetMethod(
...
//             populateMetadataMethod.Invoke(
//                 null,
//                 new object[] { context.MethodInfo, endpointBuilder }
//             );
//
//             var responseTypes = endpointBuilder
//                 .Metadata.Cast<IProducesResponseTypeMetadata>()
//                 .ToList();
